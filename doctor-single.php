    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg"><?php echo $doctor['name']; ?></h1>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="doctor-img-block">
					...
					<div class="info-block mt-4">
						<h4 class="mb-0"><?php echo $doctor['id']; ?></h4>
			...
			<div class="col-lg-8 col-md-6">
				<div class="doctor-details mt-4 mt-lg-0">
					...
					<a href="appoinment.php?doctor_id=<?php echo $doctor['id']; ?>" class="btn btn-main-2 btn-round-full mt-3">Make an Appoinment<i class="icofont-simple-right ml-2  "></i></a>
				</div>
			</div>
		</div>
	</div>
